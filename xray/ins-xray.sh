...
#wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/myridwan/src1/ipuk/dll/bbr.sh"
#chmod +x /usr/bin/bbr
#bbr >/dev/null 2>&1
...
sleep 1
wget -q -O /usr/bin/add-ws "https://raw.githubusercontent.com/myridwan/src1/ipuk/xray/add-ws.sh" && chmod +x /usr/bin/add-ws
wget -q -O /usr/bin/add-vless "https://raw.githubusercontent.com/myridwan/src1/ipuk/xray/add-vless.sh" && chmod +x /usr/bin/add-vless
wget -q -O /usr/bin/add-tr "https://raw.githubusercontent.com/myridwan/src1/ipuk/xray/add-tr.sh" && chmod +x /usr/bin/add-tr
wget -q -O /usr/bin/del-user "https://raw.githubusercontent.com/myridwan/src1/ipuk/xray/del-ws.sh" && chmod +x /usr/bin/del-user
wget -q -O /usr/bin/renew-ws "https://raw.githubusercontent.com/myridwan/src1/ipuk/xray/renew-ws.sh" && chmod +x /usr/bin/renew-ws
wget -q -O /usr/bin/crtv2ray "https://raw.githubusercontent.com/myridwan/src1/ipuk/xray/crt.sh" && chmod +x /usr/bin/crtv2ray
wget -q -O /usr/bin/add-ssws "https://raw.githubusercontent.com/myridwan/src1/ipuk/xray/add-ssws.sh" && chmod +x /usr/bin/add-ssws
sleep 1
